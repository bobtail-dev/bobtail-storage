...
(function() {
  var _, __boolPrefix, __jsonPrefix, __nullPrefix, __numberPrefix, __prefix, boolPrefix, getType, jsonPrefix, nullPrefix, numberPrefix, prefixFuncs, rx, storageMapObject, types;
  ...
  storageMapObject = function(storageType) {
    var _getItem, _removeItem, safeRemove, storageMap, windowStorage;
